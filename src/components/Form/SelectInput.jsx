    ...
    <div>
        ...
        <div className="relative z-20 bg-white dark:bg-form-input">
            ...
            <select value={selectedOption} onChange={(e) => {
                ...
                changeTextColor();
            }} className={`relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-12 py-3 outline-none transistion focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input ${isOptionSelected ? "text-black dark:text-white" : ""} `}>
