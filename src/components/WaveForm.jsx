...
export default function WaveForm(props) {
    ...
    const [currenTime, setCurrentTime] = useState('0:00');
    ...
    useEffect(() => {
        if (waveformRef.current) {
            ...
            ws.on("audioprocess", () => {
                const currenTime = ws.getCurrentTime();
                setCurrentTime(formatTime(currenTime));
            })
...
WaveForm.propTypes = {
    incoming: PropTypes.bool, // incoming should be a boolean
};
