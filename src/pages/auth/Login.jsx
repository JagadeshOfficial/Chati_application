        ...
        <div className="border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-screen">
            <div className="flex flex-wrap items-center h-full">
                <div className="hidden w-full xl:block xl:w-1/2">
                    <div className="py-17.5 px-26 text-center"> {/* Updated padding */}
                        <Link to="/" className="mb-5 inline-block">
                            <Logo />
                        </Link>
                        <p className="px-6 text-gray-600 dark:text-gray-300"> {/* Updated text class */}
                    ...
                    <div className='w-full p-4 sm:p-12.5 xl:p-17.5'>
                        ...
                        <form action=''>
                            ...
                            <div className='mb-6'>
                                ...
                                <div className='relative'>
                                    <input type='password' placeholder='6+ characters, 1 Captial Letter '
                                        className='w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary'
                                    />
                                    <span className='absolute right-4 top-4'>
                                        <Lock size={24} />
                            ...
                            <div className='mb-5'>
                                <input onClick={() => {
                                    navigate("/dashboard");
                                }} type='submit' value='Sign In' className='w-full cursor-pointer border border-primary bg-primary p-4 rounded-lg text-white transition hover:bg-opacity-90' />
                            </div>
                            <button onClick={() => {
                                    navigate("/dashboard");
